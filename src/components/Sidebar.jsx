  ...
  return (
    <>
      <div class="min-h-screen flex flex-row bg-gray-100">
        <div class="flex flex-col w-58 bg-white rounded-r-3xl overflow-hidden">
            ...
            {verticals.map((vertical) => (
              <li>
                <button onClick={() => setVertical(vertical)}>
                  <span
                    class={`text-base font-medium flex flex-row items-center h-12 transform hover:translate-x-2 transition-transform ease-in duration-200 text-gray-500 px-2 hover:text-gray-800 ${
                      vertical == currentvertical ? "text-blue-500" : ""
                    }`}
                  >
                    {vertical}
                  </span>
